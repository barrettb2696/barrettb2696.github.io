...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.4f, 0.4f, 0.04f);
	...
	m_pShaderManager->setFloatValue("lightSources[0].specularIntensity", 0.25f);



	m_pShaderManager->setVec3Value("lightSources[1].position", 0.0f, 1.5f, -7.0f);
